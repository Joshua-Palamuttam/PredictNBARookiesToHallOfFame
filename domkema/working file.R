# Working script file
# Josh Palamuttam, Albert Udom, Michael Domke
# Team Space JAM
...
# Josh
setwd("C:/Users/Administrator/Desktop/CS/Junior/Quarter 3/Machine Learning/Project work/Data sets")
...
plot(x = rookie_clusters$cluster, y = rookie_clusters$centers[1,],
